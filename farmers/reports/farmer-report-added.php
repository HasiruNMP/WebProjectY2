...
$sql="INSERT INTO reports (email, fname, lname, crop_name, crop_type, quantity, photo1, photo2, photo3, lat, longt, description, date) VALUES ('$email', '$firstname', '$lastname', '$cropname', '$croptype', '$quantity', '$img', '$img2', '$img3','$latitude', '$longitude', '$descrip', CURDATE());";
}
